        ...
        try {
            ...
            try {
                ...
                if (monitorText.contains("Success: You have added Apple Cinema 30")) {
                    ...
                    System.out.println("Monitor message appeared but content mismatch.");
                }
            } catch (Exception e) {
            ...
            try {
                ...
                System.out.println(" Wish list message not found: " + e.getMessage());
            }
            ...
            try {
                ...
                if (mobileText.contains("Success: You have added HTC Touch HD")) {
                    ...
                    System.out.println("Mobile message appeared but content mismatch.");
                }
            } catch (Exception e) {
